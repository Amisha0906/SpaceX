...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        success_counts = spacex_df[spacex_df['class'] == 1]  # Filter only successful launches
        success_counts = success_counts.groupby('Launch Site').size().reset_index(name='count')
        ...
        fig = px.pie(success_counts, 
                 names='class',  # Now 'class' contains 0 (fail) and 1 (success)
                 values='count', 
